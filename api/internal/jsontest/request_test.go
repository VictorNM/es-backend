...
func TestMethod(t *testing.T) {
	tests := []struct {
		...
		{
			f: func() *http.Request {
				return jsontest.WrapGET("/users").Unwrap()
			},
		...
		{
			f: func() *http.Request {
				return jsontest.WrapPOST("/users", nil).Unwrap()
			},
		...
		{
			f: func() *http.Request {
				return jsontest.WrapPUT("/users", nil).Unwrap()
			},
		...
		{
			f: func() *http.Request {
				return jsontest.WrapPATCH("/users", nil).Unwrap()
			},
		...
		{
			f: func() *http.Request {
				return jsontest.WrapDELETE("/users", nil).Unwrap()
			},
...
func TestBodyJSON(t *testing.T) {
	tests := map[string]struct {
		f func(wrapper *jsontest.RequestWrapper)
...
func TestQuery(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			wrapper := jsontest.WrapGET(test.initURI)
			test.f(wrapper)
...
func TestParam(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			req := jsontest.WrapGET(test.template).
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			rw := jsontest.WrapGET(test.template)
